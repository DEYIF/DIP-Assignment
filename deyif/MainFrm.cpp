...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	try {
		...
		m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CDEYIFExperiment1View), CSize(rc.Width(), rc.Height() ), pContext);
		m_wndSplitter.CreateView(1, 0, RUNTIME_CLASS(CViewChooseManyRaws), CSize(rc.Width()*0, rc.Height() * 0), pContext);
	}
	catch (...) {
